  ...
  return (
    <div className="w-[301px] h-[312px] bg-white rounded-[10px] shadow-[0px_4px_13px_rgba(0,0,0,0.08)] overflow-hidden">
      ...
      <div className="p-3 flex flex-col gap-1.5">
        <h3 className="text-[#285f9d] text-xl font-medium font-['Inter']">
          {product.title}
        </h3>
        ...
        <Link
          ...
          className="inline-block w-[85px] h-10 bg-[#285f9d] text-white text-base rounded-[5px] text-center leading-10 mt-3 font-['Inter']"
        >
          More
        </Link>
      </div>
